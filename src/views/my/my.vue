...
const avatar = new URL('@/assets/profile/moxueyi.png', import.meta.url).href;
...
<template>
    <div class="my">
        <div class="content">
            ...
            <div class="nikename">moxueyi</div>
            <div class="signature"><span>签名：</span>be lemon</div>
            <div class="link">
                ...
                <span><a target="_blank" href="https://github.com/moxueyi/anime-list.git">Github仓库</a></span>
            </div>
        </div>
    </div>
</template>
